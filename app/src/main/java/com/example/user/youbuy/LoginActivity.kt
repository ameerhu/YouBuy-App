...
import com.example.user.youbuy.Model.Product
...
class LoginActivity : AppCompatActivity(), LoaderCallbacks<Cursor> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(intent.extras.getBoolean("empty"))
            pDetailCall = true
            else
...
//        }
    ...
    inner class UserLoginTask internal constructor(private val mEmail: String, private val mPassword: String) :
        ...
        internal var URL = "https://rocky-ocean-68053.herokuapp.com/api/Customers/login?include=user"
        ...
        override fun onPostExecute(success: Boolean?) {
            ...
            if (success!!) {
                finish()
                Log.e("In Post", "Excecution task completed.")
            } else {
